...
//STM32Æ½Ì¨ï¿½ï¿½ï¿?
	...
	#include "gd32f30x.h"
	#include "FreeRTOS.h"				//    #error "include FreeRTOS.h" must appear in source files before "include semphr.h"£¬ÎÊÌâ£¬µ÷ÓÃ²¿·ÖÍ·ÎÄ¼şÇ°ĞèÏÈµ÷ÓÃFreeRTOS.h
	#include "semphr.h"
	typedef struct Port_Inf
	{
	    uint32_t port;
...
#define SYS_FREERTOS_STAT_OPEN			1

#if SYS_FREERTOS_STAT_OPEN
	#include "FreeRTOS.h"
	#include "task.h"
	#include "queue.h"
#endif
